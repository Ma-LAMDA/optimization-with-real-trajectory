...
attempt 1 全新启动，不恢复旧断点。截至 2026-08-04 的阶段性数据快照包含 57 道已到达
终态的题目和 384 条 accepted 轨迹：36 题收齐 10 条正确轨迹，19 题因连续 10 次错误
停止，2 题因累计 20 次错误停止；仍在生成或等待调度的题目未纳入该快照。新运行强制采用
accepted-only 保留策略：
