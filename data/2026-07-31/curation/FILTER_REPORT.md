...
- 训练集：759 条，78 个题号
- 验证集：60 条，6 个题号（12、24、40、72、86、100）
- 训练/验证题号交集：0
...
每种合并后的故障类型整题留出 1 题。先选择该类型中严格正确轨迹数最多的题；若并列，则选择题号最大的题。训练集与验证集继续以 `case_id` 隔离。

| 故障类型 | 验证题号 | 验证轨迹 | 训练题数 | 训练轨迹 |
| --- | ---: | ---: | ---: | ---: |
| `STP BPDU被过滤` | 24 | 10 | 11 | 110 |
| `VRRP Master角色规划不合理` | 86 | 10 | 13 | 130 |
| `VRRP工作在非抢占模式` | 100 | 10 | 13 | 129 |
| `全局STP未使能` | 12 | 10 | 11 | 90 |
| `存在IP路由环路` | 40 | 10 | 15 | 150 |
| `存在MPLS标签环路` | 72 | 10 | 15 | 150 |
...
| 12 | 19 | 10 | 52.63% | 329.861 | 340.513 | 19/19 | 9 | 0 | 0 | 10 | validation | completed_with_10_correct |
...
| 24 | 30 | 10 | 33.33% | 369.658 | 432.410 | 30/30 | 20 | 0 | 0 | 10 | validation | completed_with_10_correct |
...
| 40 | 12 | 10 | 83.33% | 482.374 | 501.193 | 12/12 | 2 | 0 | 0 | 10 | validation | completed_with_10_correct |
...
| 72 | 10 | 10 | 100.00% | 274.552 | 274.552 | 10/10 | 0 | 0 | 0 | 10 | validation | completed_with_10_correct |
...
| 86 | 10 | 10 | 100.00% | 100.945 | 100.945 | 10/10 | 0 | 0 | 0 | 10 | validation | completed_with_10_correct |
