...
> 2026-08-07 标签修正：q73-q86 现在接受 A、B 或 A+B（任意顺序）。本实验这14题均已有
> 10条 accepted 轨迹，共140条；失败 payload 按本实验既定策略未长期保留，现有可恢复结果
> 无需改判，因此总 accepted 数仍为840。原始轨迹和旧 judgment 保持不变，修正审计见
> `../../docs/2026-08-07_Q73_Q86_INCLUSIVE_OR_RESCORE.md`。
